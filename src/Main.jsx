...
export default function Main() {
  ...
  const answers = [
    ...
    !question ? "Vai me dar o C kkkkk 🤩❤??? " : question,
  ]
              ...
              {!id ? (
                <>
                  <p className="font-semibold" align="center">"
                    <b>Clicou em SIM, agora não tem volta emm, vai ter que dar kkkkkkk"</b> 
                  </p>

                  <p align="center">Não forcei nada, vc que apertou em Sim Vida,
                  brincadeiras a parte kkkkk TE AMO ❤</p>
